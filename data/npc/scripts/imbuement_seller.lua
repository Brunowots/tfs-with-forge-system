...
local function creatureSayCallback(cid, type, msg)
	...
	elseif msgcontains(msg, "yes") and npcHandler.topic[cid] == 1 then
		if player:removeMoneyNpc(800000) then
...
npcHandler:setMessage(MESSAGE_GREET, "Hello |PLAYERNAME| say {trade} to buy imbuiment. Say {Bash}, {Blockade}, {Chop}, {Epiphany}, {Precision}, {Slash}, {Electrify}, {Frost}, {Reap}, {Scorch}, {Venom}, {Cloud Fabric}, {Demon Presence}, {Dragon Hide}, {Lich Shroud}, {Quara Scale}, {Snake Skin}, {Featherweight}, {Strike}, {Swiftness}, {Vampirism}, {Vibrancy}, {Void} items for 800k.")
