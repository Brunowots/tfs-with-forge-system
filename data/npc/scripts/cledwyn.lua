...
local chargeItem = {
	...
	['turtle amulet'] = {noChargeID = 46016, ChargeID = 46014},
	['alicorn ring'] = {noChargeID = 45963, ChargeID = 45961},
	['arboreal ring'] = {noChargeID = 45969, ChargeID = 45967},
	['arcanomancer sigil'] = {noChargeID = 45966, ChargeID = 45964},
	['spiritthorn ring'] = {noChargeID = 45960, ChargeID = 45958}
}
...
function creatureSayCallback(cid, type, msg)
	...
	elseif msgcontains(msg, 'enchant') then
		npcHandler:say("The following items can be enchanted: {pendulet}, {sleep shawl}, {blister ring}, {alicorn ring}, {arboreal ring}, {arcanomancer sigil}, {spiritthorn ring}, {theurgic amulet}, {turtle amulet}. Make you choice!", cid)
	...
	elseif isInArray({'turtle amulet', 'alicorn ring', 'arboreal ring', 'arcanomancer sigil','spiritthorn ring',}, msg:lower()) and npcHandler.topic[cid] == 1 then
