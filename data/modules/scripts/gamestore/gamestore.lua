...
GameStore.Categories = {
  ...
  
  {
    ...
    name = "Consumables",
    rookgaard = true,
    subclasses = {"Exercise Weapons", "Kegs", "Potions", "Runes"},
  },
  -- Exercise Weapons
	{
  ...
  -- Base outfit has addon = 0 or no defined addon. By default addon is set to 0.
  {
    ...
    offers = {
      ...
      {
        icons = { "Outfit_Assassin_Female_Addon_3.png", "Outfit_Assassin_Male_Addon_3.png" },
      ...
      {
        name = "Full Forest Warden Outfits",
        price = 150,
  ...
  },
  {
    ...
    offers = {
	  ...
	  {
        icons = { "sculpture_of_an_octopuz.png" },
        name = "Sculpture of an Octopuz",
        price = 20,
        itemtype = 42042,
        count = 1,
        description = "{house}\n{box}\n{storeinbox}\n{use}\n{backtoinbox}",
      ...
      },
      {
        ...
        count = 1,
        description = "{house}\n{box}\n{storeinbox}\n{use}\n{backtoinbox}",
        type = GameStore.OfferTypes.OFFER_TYPE_DECORATION_KIT,
      },
      {
        icons = { "All-Seeing_Tapestry.png" },
        name = "All-Seeing Tapestry",
	  ...
	  {
        icons = { "folded_dragon_lord_carpet.png" },
      ...
      },
      {
	   ...
	   {
        icons = { "folded_dragon_carpet.png" },
	  ...
	  {
        icons = { "folded_elemental_carpet.png" },
	  ...
	  {
        icons = { "folded_morgaroth_carpet.png" },
	  ...
	  {
        icons = { "folded_orshabaal_carpet.png" },
      ...
      {
       icons = { "folded_red_cake_carpet.png" },
	  ...
	  {
        icons = { "folded_orange_cake_carpet.png" },
	  ...
	  {
        icons = { "folded_yellow_cake_carpet.png" },
	  ...
	  {
        icons = { "folded_green_cake_carpet.png" },
	  ...
	  {
        icons = { "folded_sky_cake_carpet.png" },
	  ...
	  {
        icons = { "folded_blue_cake_carpet.png" },
	  ...
	  {
        icons = { "folded_purple_cake_carpet.png" },
	  ...
	  {
        icons = { "folded_pink_cake_carpet.png" },
	  ...
	  {
        icons = { "folded_red_tibia_carpet.png" },
      ...
      },
      {
	   ...
	   {
        icons = { "folded_orange_tibia_carpet.png" },
	  ...
	  {
        icons = { "folded_yellow_tibia_carpet.png" },
	  ...
	  {
        icons = { "folded_green_tibia_carpet.png" },
	  ...
	  {
        icons = { "folded_sky_tibia_carpet.png" },
	  ...
	  {
        icons = { "folded_blue_tibia_carpet.png" },
	  ...
	  {
        icons = { "folded_purple_tibia_carpet.png" },
	  ...
	  {
        icons = { "folded_pink_tibia_carpet.png" },
  ...
  --Furniture
  {
    ...
    offers = {
	  ...
	  {
        icons = { "filled_kraken_shelf.png" },
        name = "Filled Kraken Shelf",
        price = 20,
        itemtype = 42027,
        count = 1,
        description = "{house}\n{box}\n{storeinbox}\n{useicon} use it to open up some storage space\n{backtoinbox}",
  ...
  -- Fansite
   ...
   icons = { "Category_Tournament.png" },
    ...
    offers = {
     {
          icons = { "beaver_of_wisdom.png" },
          name = "Beaver of Wisdom",
          price = 1000,
          itemtype = 43515,
          count = 1,
          description = "Hyper Rare Item only Mex Fans",
          type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
      },
	  {
          icons = { "mage_hat.png" },
		...
		{
          icons = { "luna_(tibiagoals).png" },
          name = "Luna (Tibiagoals)",
          price = 1000,
          itemtype = 41831,
          count = 1,
           description = "Hyper Rare Item only Mex Fans",
		...
		{
          icons = { "bella_bonecrusher's_doll.png" },
  ...
  -- Boost
 {
  ...
  -- Extras
  {
    ...
    name = "Extras",
    rookgaard = true,
    subclasses = {"Special Mex", "Extra Services", "Useful Things"},
  },
   -- Special Horizon
   {   
    icons = { "Category_Tournament.png" },
...
{   
  ...
  offers = { 
      ...
      },
      {
        ...
        price = 50,
        itemtype = 5942,
        description = "<i>Blessed Wooden Stake",
        type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
      },
      {
        icons = { "Gold_Converter.png" },
 ...
 -- Tools
  ...
  },
  {
    ...
    rookgaard = true,
    subclasses = {"Exercise Weapon","Items","XP Boost","Prey Wildcard"},
  },
  -- Extras Services
  {
    icons = { "Category_ExerciseWeapons.png" },
    name = "Exercise Weapon",
    parent = "Tournament Coins",
    rookgaard = true,
    state = GameStore.States.STATE_NONE,
    offers = {
      {
...

  {
    ...
    offers = {
      ...
      {
        icons = { "Sneaky Stabber of Eliteness.png" },
        name = "Sneaky Stabber of Eliteness",
        price = 540	,
        itemtype = 10511,
        description = "(This nifty gadget can be used for many vital and less vital purposes. If it's not jammed, that is)",
