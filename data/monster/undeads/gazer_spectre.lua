...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 25, type = COMBAT_FIREDAMAGE, minDamage = -200, maxDamage = -350, range = 7, shootEffect = CONST_ANI_ENERGY, target = false},
	...
	{name ="gazer chase", interval = 2000, chance = 15, minDamage = -250, maxDamage = -430, target = false}
}
