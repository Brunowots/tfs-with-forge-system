...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 20, type = COMBAT_EARTHDAMAGE, minDamage = -180, maxDamage = -390, radius = 4, effect = CONST_ME_GREEN_RINGS, target = false},
...
monster.defenses = {
	defense = 69,
	armor = 69,
	{name ="combat", interval = 2000, chance = 10, type = COMBAT_HEALING, minDamage = 60, maxDamage = 140, effect = CONST_ME_MAGIC_BLUE, target = false}
}
