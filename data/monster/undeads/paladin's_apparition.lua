...
monster.loot = {
	{name = "crystal coin", chance = 81690},
	{name = "violet gem", chance = 5080},
	{name = "green gem", chance = 5080},
	{name = "blue gem", chance = 6100},
	{name = "warrior helmet", chance = 7120},
	{name = "great spirit potion", chance = 5420},
	{name = "glacier mask", chance = 5080},
	{name = "wood cape", chance = 3050},
	{name = "skull helmet", chance = 1360},
	{name = "glacier amulet", chance = 5080},
	{name = "stone skin amulet", chance = 1690},
	{id = 26185, chance = 1360}, -- Ring of blue plasma
	{id = 23542, chance = 1020}, -- Collar of blue plasma
...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 20, type = COMBAT_HOLYDAMAGE, minDamage = -650, maxDamage = -1400, range = 7, shootEffect = CONST_ANI_HOLY, effect = CONST_ME_HOLYDAMAGE, target = true},
	{name ="combat", interval = 2000, chance = 15, type = COMBAT_ICEDAMAGE, minDamage = -900, maxDamage = -1100, range = 7, shootEffect = CONST_ANI_SMALLICE, effect = CONST_ME_ICEATTACK, target = true},
