...
monster.loot = {
	{name = "small diamond", chance = 910, maxCount = 3},
	{name = "gold coin", chance = 30000, maxCount = 100},
	{name = "gold coin", chance = 30000, maxCount = 100},
	{name = "gold coin", chance = 36000, maxCount = 32},
	{name = "crossbow", chance = 6050},
	{name = "burst arrow", chance = 7940, maxCount = 10},
	{name = "dragon ham", chance = 34880},
	{name = "dragonbone staff", chance = 110},
	{name = "strong health potion", chance = 20230},
	{name = "strong mana potion", chance = 15220},
	{name = "lightning pendant", chance = 750},
	{name = "composite hornbow", chance = 110},
	{name = "focus cape", chance = 1230},
	{name = "hibiscus dress", chance = 310},
	{name = "wand of starstorm", chance = 460},
	{name = "wand of draconia", chance = 1010},
	{name = "shockwave amulet", chance = 80},
	{name = "wyrm scale", chance = 14970}
}
...
monster.attacks = {
	...
	{name ="wyrm wave", interval = 2000, chance = 40, minDamage = -80, maxDamage = -170, target = false},
	...
	{name ="combat", interval = 2000, chance = 10, type = COMBAT_LIFEDRAIN, minDamage = -0, maxDamage = -145, length = 4, spread = 3, effect = CONST_ME_POFF, target = false}
}
