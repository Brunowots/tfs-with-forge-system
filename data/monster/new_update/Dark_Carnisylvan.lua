...
monster.loot = {
	...
	{name = "carnisylvan finger", chance = 9800, maxcount = 6},
	{name = "carnisylvan bark", chance = 9800, maxcount = 6},
	{name = "hailstorm rod", chance = 1980},
	{id = 8901, chance = 1980},
	{name = "underworld rod", chance = 4030},
	{name = "springsprout rod", chance = 1890},
	{name = "wand of starstorm", chance = 5120},
	{name = "gold ring", chance = 500},
	{name = "butterfly ring", chance = 91},
	{id = 41642, chance = 90}
}
