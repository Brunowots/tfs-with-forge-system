...
monster.loot = {
	...
	{name = "Phantasmal Axe", chance = 300},
	{name = "Soulful Legs", chance = 300},
	{name = "The Spectral Scrap of Cloth", chance = 500},
...
monster.attacks = {
	...
	{name ="combat", interval = 3000, chance = 30, type = COMBAT_DEATHDAMAGE, minDamage = -700, maxDamage = -1100, radius = 4, effect = CONST_ME_MORTAREA, target = false},
	{name ="combat", interval = 3000, chance = 40, type = COMBAT_FIREDAMAGE, minDamage = -700, maxDamage = -1400, range = 7, shootEffect = CONST_ANI_FIRE, effect = CONST_ME_FIREAREA, target = true},
	{name ="combat", interval = 4000, chance = 50, type = COMBAT_FIREDAMAGE, minDamage = -700, maxDamage = -1300, length = 8, effect = CONST_ME_EXPLOSIONHIT, target = false},
	{name ="combat", interval = 4000, chance = 12, type = COMBAT_DEATHDAMAGE, minDamage = -700, maxDamage = -1100, range = 5, length = 5, spread = 3, effect = CONST_ME_WHITE_ENERGY_SPARK, target = true}
}
...
mType.onAppear = function(monster, creature)
	...
	monster:registerEvent("thePaleWormOnDeah")
end
