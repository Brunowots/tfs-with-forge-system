...
monster.loot = {	
	...
	{name = "falcon mace", chance = 200, maxCount = 1},
	{name = "grant of arms", chance = 200, maxCount = 1},
	{name = "falcon bow", chance = 200, maxCount = 1},
	{name = "falcon circlet", chance = 200, maxCount = 1},
	{name = "falcon coif", chance = 200, maxCount = 1},
	{name = "falcon rod", chance = 200, maxCount = 1},
	{name = "falcon wand", chance = 200, maxCount = 1},
