...
monster.loot = {
	{name = "silver token", chance = 27320},
	{name = "gold token", chance = 15300},
	...
	{id = 26185, chance = 8762}, -- ring of blue plasm
...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 10, type = COMBAT_DEATHDAMAGE, minDamage = -200, maxDamage = -500, length = 8, spread = 3, effect = CONST_ME_LOSEENERGY, target = false},
	{name ="combat", interval = 2000, chance = 15, type = COMBAT_DEATHDAMAGE, minDamage = -140, maxDamage = -450, radius = 4, effect = CONST_ME_MORTAREA, target = false},
