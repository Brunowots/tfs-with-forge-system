...
monster.loot = {
	...
	{id = 7404, chance = 430}, -- assassin dadger
...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 20, type = COMBAT_EARTHDAMAGE, minDamage = 0, maxDamage = -900, range = 4, radius = 4, effect = CONST_ME_STONES, target = true},
...
mType.onAppear = function(monster, creature)
	...
	monster:registerEvent("SandkingThink")
end
