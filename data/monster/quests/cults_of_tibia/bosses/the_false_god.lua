...
monster.loot = {
	...
	{name = "velvet mantle", chance = 500},
	{name = "iron ore", chance = 14542},
	{name = "giant sword", chance = 16892}
}

monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = -220, maxDamage = -750},
	{name ="combat", interval = 2000, chance = 20, type = COMBAT_EARTHDAMAGE, minDamage = -300, maxDamage = -600, range = 4, radius = 4, effect = CONST_ME_STONES, target = true},
