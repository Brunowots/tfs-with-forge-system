...
monster.summons = {
	{name = "Hardened Usurper Archer", chance = 50, interval = 2000, max = 2},
	{name = "Hardened Usurper Knight", chance = 50, interval = 2000, max = 2},
	{name = "Hardened Usurper Warlock", chance = 50, interval = 2000, max = 1},
}
