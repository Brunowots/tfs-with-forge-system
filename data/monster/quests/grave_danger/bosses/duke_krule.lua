...
monster.attacks = {
	...
	{name ="combat", interval = 1800, chance = 60, type = COMBAT_PHYSICALDAMAGE, minDamage = -750, maxDamage = -1000, length = 7, spread = 3, effect = CONST_ME_BLOCKHIT, target = false},
	{name ="combat", interval = 1800, chance = 40, type = COMBAT_FIREDAMAGE, minDamage = -600, maxDamage = -900, radius = 10, effect = CONST_ME_HITBYFIRE, target = false}
}
