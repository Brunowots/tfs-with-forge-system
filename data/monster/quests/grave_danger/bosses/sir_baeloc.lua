...
monster.loot = {
	...
	{id = 36427, chance = 200}, -- signet ring
...
monster.attacks = {
	{name ="combat", interval = 1800, chance = 40, type = COMBAT_MANADRAIN, minDamage = -800, maxDamage = -1000, radius = 5, effect = CONST_ME_MAGIC_RED, target = false},
	{name ="combat", interval = 1800, chance = 89, type = COMBAT_PHYSICALDAMAGE, minDamage = -1000, maxDamage = -1300, length = 7, spread = 3, target = false}
}
