...
monster.summons = {
	{name = "Dreadful Harvester", chance = 80, interval = 4000, max = 2},
	{name = "Malicious Soul", chance = 80, interval = 4000, max = 2},
...
mType.onAppear = function(monster, creature)
	...
	monster:registerEvent("maliceOnChangeHealth")
