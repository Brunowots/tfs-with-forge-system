...
monster.summons = {
	{name = "Dreadful Harvester", chance = 75, interval = 4000, max = 2},
	{name = "Weeping Soul", chance = 75, interval = 4000, max = 2}
}
...
mType.onAppear = function(monster, creature)
	...
	monster:registerEvent("spiteOnChangeHealth")
