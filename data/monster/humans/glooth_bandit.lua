...
monster.attacks = {
	{name ="melee", interval = 2000, chance = 95, minDamage = 0, maxDamage = -319},
	{name ="melee", interval = 2000, chance = 95, skill = 80, attack = 68},
	{name ="combat", interval = 2000, chance = 25, type = COMBAT_PHYSICALDAMAGE, minDamage = -60, maxDamage = -200, range = 8, shootEffect = CONST_ANI_ARROW, target = false}
}
