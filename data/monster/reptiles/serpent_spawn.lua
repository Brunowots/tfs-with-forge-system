...
monster.attacks = {
	...
	{name ="speed", interval = 2000, chance = 20, speedChange = -500, range = 7, radius = 4, shootEffect = CONST_ANI_POISON, effect = CONST_ME_GREEN_RINGS, target = true, duration = 12000},
