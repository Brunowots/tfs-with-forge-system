local mType = Game.createMonsterType("Warlock Boss")
local monster = {}

monster.description = "Warlock Boss"
...
monster.summon = {
	maxSummons = 3,
	summons = {
		{name = "animated Sword", chance = 10, interval = 2000, count = 1}
	}
}
monster.flags = {
	summonable = false,
...
monster.loot = {	
	...
	{name = "crystal coin", minCount = 5, maxCount = 60, chance = 50000},
	{name = "gold token", minCount = 1, maxCount = 6, chance = 15000},
	{name = "silver token", minCount = 1, maxCount = 6, chance = 25000},
	...
	{name = "gold ingot", minCount = 1, maxCount = 5, chance = 15000},
