...
monster.loot = {
	{name = "gold coin", chance = 79360, maxCount = 100},
	{name = "platinum coin", chance = 91340, maxCount = 7},
...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 10, type = COMBAT_PHYSICALDAMAGE, minDamage = -200, maxDamage = -450, length = 5, spread = 3, effect = CONST_ME_EXPLOSIONAREA, target = false},
	...
	{name ="combat", interval = 2000, chance = 10, type = COMBAT_LIFEDRAIN, minDamage = -350, maxDamage = -600, radius = 4, effect = CONST_ME_MAGIC_RED, target = false}
}
