...
Storage = {
	...
	DreamCoutsBossesKill = {
		facelessBane = 30141,
		izcandarTheBanished = 30142,
		malofurMangrinder = 30143,
		maxxenius = 30144,
		plagueroot = 30145,
	},
	...
	GraveDangerBossesKill = {
		CountVlarkorth = 30127,
		LordAzaram = 30128,
		EarlOsam = 30129,
		SirNictros = 30130,
		DukeKrule = 30131,
	...
	WereWolfMiniBosses = {
		BloodBackTimer = 30122,
		DarkFangTimer = 30123,
		SharpclawTimer = 30124,
		ShadowpeltTimer = 30125,
		BlackVixenTimer = 30126,
	},
	FeasterOfSouls = { 
	...
	-- 30100 to 30116 used by drome potions
	firstCoinsBeta = 30057,
	NpcHealTalkDelay = 30056,
	DoubleExp = 15876,
	-- General storages
	...
	DeeplingBosses = {
		...
		hasAlreadyEnteredStorage = 30117,
		nextSpawnTime = 30118,
	},
	DangerousDepths = {
...
GlobalStorage = {
	drume_spawned = 30166,
	SoulWar = {
		maliceForceIncreaseCount = 50013,
		maliceGroundIndex = 50014,
		hatredForceIncreaseCount = 50015,
		spiteForceIncreaseCount = 50016,
		crueltyForceIncreaseCount = 50017,
		greedbeastKillCount = 50018,
		aspectOfPowerKillCount = 50019,
		megalomaniaImortal = 50020,
		-- MaliceMechanicActived = {
			-- ground = 50013,
			-- cage = 50014,
		-- },
	},
	CultsOfTibia = {
		EssenceOfMaliceMiniDeads = 50009,
		SandKingThink = 50012,
	},
	BrainHeadFirst = 50008,
	BrainHeadInSession = 50007,
	OberonHealCount = 50006,
	DangerousDepths = {
	...
	FerumbrasAscendant = {
		...
		TheShattererLever = 65015,
		TheShattererTimer = 65016,
		FlowerPuzzleTimer = 65017,
		ShulgraxTimer = 65018,
		PlagirathTimer = 65019,
		RagiazTimer = 65020,
		thelordofthelice = 65021,
		Razzagorn = 65022,
		Tarbaz = 65023,
