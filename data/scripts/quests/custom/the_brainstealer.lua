...
local config = {
	requiredLevel = 400,
	daily = true,
	roomCenterPosition = Position(32532, 31124, 15),
	playerPositions = {
		Position(32564, 31122, 15),
		Position(32565, 31122, 15),
		Position(32566, 31122, 15),
		Position(32567, 31122, 15),
		Position(32568, 31122, 15)
	},
	teleportPosition = Position(32536, 31129, 15),
	bossPosition = Position(32532, 31120, 15)
}
...
function leverboss.onUse(player, item, fromPosition, target, toPosition, isHotkey)
	if item.itemid == 9825 then
		...
		-- Spawn boss
		Game.createMonster("The Brainstealer", config.bossPosition)
