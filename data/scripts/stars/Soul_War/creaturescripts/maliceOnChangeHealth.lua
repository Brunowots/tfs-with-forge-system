local maliceOnChangeHealth = CreatureEvent("maliceOnChangeHealth")
...
function maliceOnChangeHealth.onHealthChange(creature, attacker, primaryDamage, primaryType, secondaryDamage, secondaryType)
