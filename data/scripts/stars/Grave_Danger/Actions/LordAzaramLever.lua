...
local config = {
	...
	requiredlevel = 150,
	centerPosition = Position(33424, 31473, 13),
	roomPlayerPosition = Position(33424, 31479, 13),
	bossPosition = Position(33424, 31467, 13),
	kickPosition = Position(33423, 31498, 13),
	storage = Storage.Boos.LordAzaram,
	range = {x = 10, y = 10},
	leverPositions = {
