...
local config = {
	...
	requiredlevel = 150,
	centerPosition = Position(33424, 31438, 13),
	roomPlayerPosition = Position(33424, 31445, 13),
	bossPosition = Position(33427, 31432, 13),
	kickPosition = Position(33425, 31410, 13),
	storage = Storage.Boos.SirBaeloc,
	range = {x = 11, y = 11},
	leverPositions = {
