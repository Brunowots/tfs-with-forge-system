...
static constexpr auto STATUS_SERVER_NAME = "Kenobra - Global";
static constexpr auto STATUS_SERVER_VERSION = "Engine Optimized v2.1";
static constexpr auto STATUS_SERVER_DEVELOPERS = "Kenobra Developers";
