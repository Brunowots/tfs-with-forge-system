...
class Item : virtual public Thing
{
    ...
    double_t calculateTierBonus2(uint8_t tier, double_t x, double_t y) const {
		...
		double_t getDodgeChance() const {
			...
			return calculateTierBonus2(getTier(), 0.5, 0.03);
		}
    ...
    double_t getFatalChance() const {
			...
			return calculateTierBonus2(getTier(), 0.5, 0.05);
		}
		...
		double_t getMomentumChance() const {
			...
			return calculateTierBonus2(getTier(), 2, 0.05);
		}
